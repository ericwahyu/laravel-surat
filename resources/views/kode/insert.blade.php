                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('penomoran') is-invalid @enderror" name="penomoran" placeholder="" value="{{ old('penomoran') }}">
                        ...
                        {{-- <div class="form-group">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('increment') is-invalid @enderror" name="increment" placeholder="" value="{{ old('increment') }}" min="1">
                                    @error('increment')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
